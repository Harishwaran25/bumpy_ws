...
class DiffTf(Node):
    ...
    def __init__(self):
        ...
        # Updated default frame IDs with bumpy7 namespace
        self.base_frame_id = self.declare_parameter('base_frame_id',
                                                   'bumpy7/base_footprint').value  # the name of the base frame of the robot
        self.odom_frame_id = self.declare_parameter('odom_frame_id',
                                                   'bumpy7/odom').value  # the name of the odometry reference frame
        ...
        # Updated subscriptions to use namespaced topics
    ...
    def update(self):
        ...
        transform_stamped_msg.header.frame_id = self.odom_frame_id  # Now "bumpy7/odom"
        transform_stamped_msg.child_frame_id = self.base_frame_id   # Now "bumpy7/base_footprint"
